                    ...
                    <div className="inner-box">
                        ...
                        <div className='dealer-registration-input-row'>
                            <div>
                                ...
                                <input type="text" className="dealer-login-input-field" placeholder='Enter venue name' required></input>
                            </div>
                            <div>
                                <span className="dealer-login-span-input">Venue location</span>
                                <input type="text" className="dealer-login-input-field" placeholder='Enter venue location' required></input>
                            </div>
                            <div>
                                <span className="dealer-login-span-input">Capacity</span>
                                <input type="number" className="dealer-login-input-field" placeholder='Enter capacity in numbers' required></input>
                            </div>
                        </div>
                        <div className='dealer-registration-input-row'>
                            <div>
                                ...
                                <div>
                                    <div className='venue-registration-input-checkbox'>
                                        <input type="checkbox" name="banquet" value="Banquet"></input> 
