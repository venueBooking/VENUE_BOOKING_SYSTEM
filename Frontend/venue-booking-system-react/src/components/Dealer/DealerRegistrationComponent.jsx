...
export const DealerRegistrationComponent = () => {
  ...
  async function startDealerRegistration(event) {
    ...
    if (
      newDealer.password !==
      document.getElementById("dealer-registration-confirm-password").value
    ) {
          ...
          <div className="inner-box">
            ...
            <div className="dealer-registration-input-row">
              <div>
                ...
                <input
                  type="text"
                  id="dealer-registration-firstname"
              ...
              <div>
                ...
                <input
                  type="text"
                  id="dealer-registration-lastname"
                  className="dealer-login-input-field"
            ...
            <div className="dealer-registration-input-row">
              <div>
                ...
                <input
                  type="text"
                  id="dealer-registration-username"
                  className="dealer-login-input-field"
              ...
              <div>
                ...
                <input
                  type="password"
                  id="dealer-registration-password"
                  className="dealer-login-input-field"
              ...
              <div>
                ...
                <input
                  type="password"
                  id="dealer-registration-confirm-password"
                  className="dealer-login-input-field"
